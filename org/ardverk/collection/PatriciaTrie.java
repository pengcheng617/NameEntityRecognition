...
/**
 * <h3>PATRICIA {@link org.ardverk.collection.Trie}</h3>
 *  
 * <i>Practical Algorithm to Retrieve Information Coded in Alphanumeric</i>
 * 
 * <p>A PATRICIA {@link org.ardverk.collection.Trie} is a compressed {@link org.ardverk.collection.Trie}. Instead of storing
 * all mmseg at the edges of the {@link org.ardverk.collection.Trie} (and having empty internal nodes),
 * PATRICIA stores mmseg in every node. This allows for very efficient traversal,
 ...
 * 
 * <p>The {@link org.ardverk.collection.Trie} can return operations in lexicographical order using the
 * {@link #traverse(org.ardverk.collection.Cursor)}, 'prefix', 'submap', or 'iterator' methods. The
 * {@link org.ardverk.collection.Trie} can also scan for items that are 'bitwise' (using an XOR
 * metric) by the 'select' method. Bitwise closeness is determined by the 
 * {@link org.ardverk.collection.KeyAnalyzer} returning true or false for a bit being set or not in
 * a given key.
 * 
 * <p>This PATRICIA {@link org.ardverk.collection.Trie} supports both variable length & fixed length
 ...
 * @author Sam Berlin
 */
public class PatriciaTrie<K, V> extends PatriciaTrieBase<K, V> implements Trie<K, V>,Serializable {
     ...
     * {@link java.util.Iterator}. The {@link java.util.SortedMap#firstEntry()},
     ...
     * This information is cached until the PATRICIA {@link org.ardverk.collection.Trie} changes.
    ...
    TrieEntry<K,V> higherEntry(K key) {
        ...
        if (lengthInBits == 0) {
            if (!root.isEmpty()) {
                // If mmseg in root, and more after -- return it.
                if (size() > 1) {
    ...
    /**
     * Returns the last entry the {@link org.ardverk.collection.Trie} is storing.
     * 
    ...
    /**
     * A range view of the {@link org.ardverk.collection.Trie}
     */
    private abstract class RangeMap extends AbstractMap<K, V> 
         ...
         * view of the {@link org.ardverk.collection.PatriciaTrie.RangeMap}
         */
         ...
         * of the {@link org.ardverk.collection.PatriciaTrie.RangeMap}
         */
        ...
        /**
         * Creates and returns a sub-range view of the current {@link org.ardverk.collection.PatriciaTrie.RangeMap}
         */
   ...
   /**
    * A {@link org.ardverk.collection.PatriciaTrie.RangeMap} that deals with {@link java.util.Map.Entry}s
    */
   private class RangeEntryMap extends RangeMap {
       ...
       /**
        * Creates a {@link org.ardverk.collection.PatriciaTrie.RangeEntryMap} with the fromKey included and
       ...
       /**
        * Creates a {@link org.ardverk.collection.PatriciaTrie.RangeEntryMap}
        */
    ...
    /**
     * A {@link java.util.Set} view of a {@link org.ardverk.collection.PatriciaTrie.RangeMap}
     */
    private class RangeEntrySet extends AbstractSet<Entry<K, V>> {
        ...
        /**
         * Creates a {@link org.ardverk.collection.PatriciaTrie.RangeEntrySet}
         */
        ...
        /** 
         * An {@link java.util.Iterator} for {@link org.ardverk.collection.PatriciaTrie.RangeEntrySet}s.
         */
        private final class EntryIterator extends TrieIterator<Entry<K,V>> {
            ...
            /**
             * Creates a {@link org.ardverk.collection.PatriciaTrie.RangeEntrySet.EntryIterator}
             */
    ...
    /** 
     * A submap used for prefix views over the {@link org.ardverk.collection.Trie}.
     */
    private class PrefixRangeMap extends RangeMap {
        ...
        /**
         * Creates a {@link org.ardverk.collection.PatriciaTrie.PrefixRangeMap}
         */
         ...
         * and TO range of the {@link org.ardverk.collection.PatriciaTrie.PrefixRangeMap} and the number
         * of elements in the range. This method must be called every 
         * time the {@link org.ardverk.collection.Trie} has changed.
         */
        private int fixup() {
        ...
        /**
         * Returns true if this {@link org.ardverk.collection.PatriciaTrie.PrefixRangeMap}'s key is a prefix
         * of the provided key.
         */
        @Override
        protected boolean inRange(K key) {
        ...
        /**
         * Returns true if the provided Key is in the FROM range
         * of the {@link org.ardverk.collection.PatriciaTrie.PrefixRangeMap}
         */
        @Override
        protected boolean inFromRange(K key, boolean forceInclusive) {
            return keyAnalyzer.isPrefix(prefix, offsetInBits, lengthInBits, key);
    ...
    /**
     * A prefix {@link org.ardverk.collection.PatriciaTrie.RangeEntrySet} view of the {@link org.ardverk.collection.Trie}
     */
    private final class PrefixRangeEntrySet extends RangeEntrySet {
        ...
        /**
         * Creates a {@link org.ardverk.collection.PatriciaTrie.PrefixRangeEntrySet}
         */
        ...
        /** 
         * An {@link java.util.Iterator} that holds a single {@link org.ardverk.collection.PatriciaTrieBase.TrieEntry}.
         */
